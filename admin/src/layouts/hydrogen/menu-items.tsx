...
import { FaUserGear, FaUsersRectangle } from 'react-icons/fa6';
...
export  function MenuItems() {
  ...
  },
  {
    ...
    dropdownItems: [
      ...
      // {
      //   name: 'Admin',
      //   href: routes.users.admin,
      // },

      {
        name: 'Members',
        href: routes.users.members,
      },
    ],
  },
  {
    ...
    dropdownItems: [
      // {
      //   name: "Groups",
      //   href: routes.groups.dashboard,
      // },
      {
        name: 'All Groups',
        href: routes.groups.allGroups,
      },
    ],
  },
]:[
