export const messages = {
  ...
  userNameIsRequired: 'Group name is required',
  memberIsRequired: 'At least one Member is required',
  adminIsRequired: 'At least one Admin is required',
  ...
  phoneNumberLengthMin: 'Phone Number must be at least 7 digits',
